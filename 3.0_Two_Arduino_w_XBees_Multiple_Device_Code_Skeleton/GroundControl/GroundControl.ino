...
//Sketch to drive an Ardunio Uno control board, process values, and transmit desired actions to blimp via XBee

//Libraries to include
#include <XBee.h>
#include <SoftwareSerial.h>  //Allows for XBee use on digital pins
...
SoftwareSerial XBeeSerial(2,3);    //RX(D_out), TX(D_in)
